...
export default ({
  teamName, username, channels, dmChannels, onAddChannelClick, teamId, onInvitePeopleClick, isOwner, onDirectMessageClick
}) => (
  <ChannelWrapper>
    <PushLeft>
    ...
    <div>
      <SideBarList>
        <SideBarListHeader>
          Direct Messages {isOwner && <Icon name="add circle" onClick={onDirectMessageClick}/>}
        </SideBarListHeader>
